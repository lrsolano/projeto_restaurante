    ...
    <b-card class="login-card">
      ...
      <b-card-body>
        <div>
          ...
          <input type="password" v-model="user.password" placeholder="Digite sua senha..." name="password" />
          <b-button pill variant="primary" class="button-login" @click="signin">Logar <b-spinner label="Spinning" v-show="loading"></b-spinner></b-button>
        </div>
      </b-card-body>
